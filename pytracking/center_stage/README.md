...
python3 center_stage.py --input_video ~/Videos/2025-02-02-ehrwld/funpark_cut.MP4  --bbox_file /home/qq/repo/pytracking/pytracking/tracking_results/dimp/dimp50/video_funpark_cut_1.txt --output_video out.mp4 --smooth_alpha 0.1 --sr_model_path ~/Downloads/ESRGAN_PSNR_SRx4_DF2K_official-150ff491.pth
```
...
To run super resolution for the zoomed in video, you need to install BasicSR. Follow the instructions here:
